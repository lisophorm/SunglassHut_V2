...
public class ViewEvent extends Event {
    ...
    public static var LOCATION_LIKE_APP:String = "Like application";
    public static var LOCATION_NON_FACEBOOK_REGISTERED:String = "Non facebook registered";
    public static var ADD_CAPTION:String = "Add caption";
