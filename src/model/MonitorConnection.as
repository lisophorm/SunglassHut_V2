...
public class MonitorConnection extends EventDispatcher {
    ...
    public static var EVENT_INTERNET_CHECK:String = "EVENT_INTERNET_CHECK";
    ...
    public function MonitorConnection(url:String) {
        ...
        monitor.pollInterval = 5000;// Milliseconds
        monitor.start();
    ...
    protected function onStatusChange(e:StatusEvent):void {
        trace("ping pong");
        this.dispatchEvent(new Event(MonitorConnection.EVENT_INTERNET_CHECK));
